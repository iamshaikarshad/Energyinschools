...
import MessagesSlider from '../../../components/EnergyScreenDashboard/v2/CommonComponents/MessagesSliderLegacy';
...
export const INITIAL_COMMON_ACTIONS = [
  {
    ...
    action: (params, dispatch) => {
      dispatch(reportOnActivity(ENERGY_DASHBOARD_VERSION.energyDashboardLegacyV2));
    },
  },
];
...
export const electricityUsageSlide = new Slide(
  ...
  [
    ...
    },
    {
      refreshInterval: 3 * MILLISECONDS_PER_HOUR,
      action: (params, dispatch) => {
        dispatch(getElectricityLeagueData(params.schoolId));
      },
    },
    {
      refreshInterval: 3 * MILLISECONDS_PER_HOUR,
