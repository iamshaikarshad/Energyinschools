...
import CartoonCharacterMain from '../../../components/EnergyScreenDashboard/v1/CartoonCharacter/CartoonCharacterMain';
import CartoonCharacterPreview from '../../../components/EnergyScreenDashboard/v1/CartoonCharacter/CartoonCharacterPreview';
import CarbonIntensityMain from '../../../components/EnergyScreenDashboard/v1/CarbonIntensity/CarbonIntensityMain';
import CarbonIntensityPreview from '../../../components/EnergyScreenDashboard/v1/CarbonIntensity/CarbonIntensityPreview';
import CashBackMain from '../../../components/EnergyScreenDashboard/v1/Cashback/CashBackMain';
import CashBackPreview from '../../../components/EnergyScreenDashboard/v1/Cashback/CashbackPreview';
import LiveConsumptionMain from '../../../components/EnergyScreenDashboard/v1/LiveConsumption/LiveConsumptionMain';
import LiveConsumptionPreview from '../../../components/EnergyScreenDashboard/v1/LiveConsumption/LiveConsumptionPreview';
import EnergyFactsListingMain from '../../../components/EnergyScreenDashboard/v1/EnergyFacts/EnergyFactsListingMain';
import EnergyFactsListingPreview from '../../../components/EnergyScreenDashboard/v1/EnergyFacts/EnergyFactsListingPreview';
import NewsWeatherMain from '../../../components/EnergyScreenDashboard/v1/NewsWeather/NewsWeatherMain';
import CurrentWeatherPreview from '../../../components/EnergyScreenDashboard/v1/NewsWeather/CurrentWeatherPreview';
...
import LoadingFailed from '../../../components/EnergyScreenDashboard/common/SlideLoad/LoadingFailed';
...
import CarbonIntensityPreviewBg from '../../../images/carbonIntensity-small-bg.svg';
...
import EnergyFactsListingMainBg from '../../../images/facts_no_data_bg.png';
import EnergyFactsListingPreviewBg from '../../../images/small-facts-bg.png';
import WeatherNewsMainBg from '../../../images/weather_main_bg.png';
...
export const INITIAL_COMMON_ACTIONS = [
  {
    ...
    action: (params, dispatch) => {
      dispatch(reportOnActivity(ENERGY_DASHBOARD_VERSION.energyDashboardV1));
    },
  },
];
