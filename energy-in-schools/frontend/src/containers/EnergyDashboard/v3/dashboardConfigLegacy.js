...
import MessagesSlider from '../../../components/EnergyScreenDashboard/v3/CommonComponents/MessagesSliderLegacy';
...
export const INITIAL_COMMON_ACTIONS = [
  {
    ...
    action: (params, dispatch) => {
      dispatch(reportOnActivity(ENERGY_DASHBOARD_VERSION.energyDashboardLegacyV3));
    },
  },
];
