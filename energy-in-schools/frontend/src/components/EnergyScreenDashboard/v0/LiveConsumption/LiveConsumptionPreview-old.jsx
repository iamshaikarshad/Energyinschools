...
const LiveConsumptionPreviewOld = ({ classes, usage }) => (
  <Grid
    container
    direction="column"
    wrap="nowrap"
...
LiveConsumptionPreviewOld.propTypes = {
  classes: PropTypes.object.isRequired,
  usage: PropTypes.number.isRequired,
};

export default withStyles(styles)(LiveConsumptionPreviewOld);
