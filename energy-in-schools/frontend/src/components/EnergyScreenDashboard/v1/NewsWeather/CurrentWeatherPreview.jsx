...
const CurrentWeatherPreview = ({ classes, currentWeather }) => {
    ...
    <Grid className={classes.root}>
      {(weather && Object.keys(weather).length > 0) ? (
        <Grid container direction="row" justify="flex-end" className={classes.withWeatherData}>
          ...
          <Grid item xs={6} container direction="row" justify="center" alignItems="center" className={classes.iconContainer}>
...
CurrentWeatherPreview.propTypes = {
  classes: PropTypes.object.isRequired,
  currentWeather: PropTypes.object.isRequired,
};


export default compose(withStyles(styles))(CurrentWeatherPreview);
